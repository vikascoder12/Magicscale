    ...
    <section id="contact" className="relative bg-gradient-to-b from-[#E9EFFD] to-white pt-[140px] pb-24 px-6 sm:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-800">
                2nd Floor, Startup Hub, Pune, India
              </span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.form
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-white p-8 text-start rounded-2xl shadow-lg border border-purple-100 backdrop-blur-md"
        >
          <div className="mb-6">
          ...
          <button
            type="submit"
            className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-6 rounded-xl transition"
          >
            Send Message
          </button>
        </motion.form>
