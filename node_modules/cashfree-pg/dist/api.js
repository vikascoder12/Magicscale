...
exports.PGWebhookEvent = exports.PGCustomerFetchInstrumentsInstrumentTypeEnum = exports.UpiChannelEnum = exports.TerminalPaymentEntityPaymentStatusEnum = exports.SimulateRequestEntityEnum = exports.RefundEntityRefundTypeEnum = exports.RefundEntityRefundStatusEnum = exports.RefundEntityEntityEnum = exports.RateLimitErrorTypeEnum = exports.PaymentEntityPaymentStatusEnum = exports.PaylaterProviderEnum = exports.PayOrderEntityActionEnum = exports.PayOrderEntityChannelEnum = exports.PayOrderEntityPaymentMethodEnum = exports.PARRequestCardTypeEnum = exports.OrderDeliveryStatusStatusEnum = exports.OrderCreateRefundRequestRefundSpeedEnum = exports.OrderAuthenticatePaymentRequestActionEnum = exports.OrderAuthenticateEntityAuthenticateStatusEnum = exports.OrderAuthenticateEntityActionEnum = exports.OfferType = exports.OfferTncResponseOfferTncTypeEnum = exports.OfferTncOfferTncTypeEnum = exports.OfferDetailsResponseOfferTypeEnum = exports.OfferDetailsOfferTypeEnum = exports.LinkCustomerDetailsEntityCustomerBankCodeEnum = exports.InstrumentEntityInstrumentStatusEnum = exports.InstrumentEntityInstrumentTypeEnum = exports.IdempotencyErrorTypeEnum = exports.EntitySimulationRequestPaymentStatusEnum = exports.DisputesEntityMerchantAcceptedDisputeStatusEnum = exports.DisputesEntityMerchantAcceptedDisputeTypeEnum = exports.DisputesEntityDisputeStatusEnum = exports.DisputesEntityDisputeTypeEnum = exports.DiscountDetailsDiscountTypeEnum = exports.CashbackDetailsCashbackTypeEnum = exports.CardlessEMIProviderEnum = exports.CardEMICardBankNameEnum = exports.CardCardBankNameEnum = exports.CardTokenTypeEnum = exports.CardChannelEnum = exports.BadRequestErrorTypeEnum = exports.AuthorizeOrderRequestActionEnum = exports.AuthorizationInPaymentsEntityStatusEnum = exports.AuthorizationInPaymentsEntityActionEnum = exports.AppProviderEnum = exports.ApiError502TypeEnum = exports.ApiError409TypeEnum = exports.ApiError404TypeEnum = exports.ApiErrorTypeEnum = void 0;
...
const CustomersApiAxiosParamCreator = function (cashfree) {
    return {
        ...
        pGCreateCustomer: (x_api_version, CreateCustomerRequest, x_request_id, x_idempotency_key, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            localVarHeaderParameter['x-sdk-platform'] = 'nodejssdk-5.0.8';
...
const UtilitiesApiAxiosParamCreator = function (cashfree) {
    return {
         ...
         * @param {string} x_api_version API version to be used. Format is in YYYY-MM-DD
         * @param {PARRequest} PARRequest Request payload for creating PAR.
         * @param {string} [x_request_id] Request id for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to cashfree
         * @param {string} [x_idempotency_key] An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * x_idempotency_key?: string,
         */
        pGCreatePAR: (x_api_version, PARRequest, x_request_id, x_idempotency_key, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'x_api_version' is not null or undefined
...
class Cashfree {
     ...
     * @memberof EligibilityApi
     */
    PGEligibilityFetchPaymentMethods(EligibilityFetchPaymentMethodsRequest, x_request_id, x_idempotency_key, options) {
        const x_api_version = this.XApiVersion;
        try {
            return EligibilityApiFp(this).pGEligibilityFetchPaymentMethods(x_api_version, EligibilityFetchPaymentMethodsRequest, x_request_id, x_idempotency_key, options).then((request) => request(this.axios, this.basePath));
        }
        catch (error) {
            if (this.XEnableErrorAnalytics) {
                Sentry.captureException(error);
     ...
     * @memberof PaymentsApi
     */
    PGPayOrder(PayOrderRequest, x_request_id, x_idempotency_key, options) {
        const x_api_version = this.XApiVersion;
        try {
            return PaymentsApiFp(this).pGPayOrder(x_api_version, PayOrderRequest, x_request_id, x_idempotency_key, options).then((request) => request(this.axios, this.basePath));
        }
        catch (error) {
            if (this.XEnableErrorAnalytics) {
                Sentry.captureException(error);
